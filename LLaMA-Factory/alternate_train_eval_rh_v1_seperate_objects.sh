...
### output
output_dir: saves/objects_rh_v1_1
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
# overwrite_output_dir: true 
...
### model
model_name_or_path: /home/hao/CCFT/Qwen2.5-VL/Qwen2.5-VL-7B-Instruct 
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/objects_rh_v1_1
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v1_1
export_size: 5
export_device: cpu
export_legacy_format: false
"
...
python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_single_rh_v1.py --task objects_rh_v1 --epoch "1"
conda deactivate
...
#   Action_verb_CONTENT="
# ### model
# model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/objects_lh_v1_${prev_epoch}
...
#   Merge_action_verb_CONTENT="
# ### model
# model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/action_verb_rh_v1_${prev_epoch}
...
#   rm temp_merge_action_verb_config.yaml
  ...
  Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v1_${prev_epoch}
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v1_${prev_epoch}
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/objects_rh_v1_${epoch}
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v1_${epoch}
export_size: 5
export_device: cpu
export_legacy_format: false
"
...
#   rm temp_merge_tool_config.yaml
  ...
  python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_single_rh_v1.py --task objects_rh_v1 --epoch ${epoch}
  conda deactivate
