...
### dataset
dataset: ikea_assembly_action_verb_train 
template: qwen2_vl 
cutoff_len: 10240 
max_samples: 100000 
...
### output
output_dir: saves/ikea_action_verb_1
logging_steps: 1 
#save_steps: 50 
plot_loss: true 
...
### model
model_name_or_path: /home/hao/CCFT/Qwen2.5-VL/Qwen2.5-VL-7B-Instruct
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/ikea_action_verb_1
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_1
export_size: 5
export_device: cpu
...
Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_1
...
### dataset
dataset: ikea_assembly_object_train 
template: qwen2_vl 
cutoff_len: 10240 
max_samples: 100000 
overwrite_cache: true 
...
### output
output_dir: saves/ikea_action_verb_object_1
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
# overwrite_output_dir: true 
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_1
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/ikea_action_verb_object_1
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_object_1
export_size: 5
export_device: cpu
export_legacy_format: false
"
...
python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_ikea.py --task ikea_action_verb_object --epoch "1"
python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_ikea.py --task ikea_action_verb --epoch "1"
conda deactivate
...
for epoch in $(seq 2 40); do
  ...
  Action_verb_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_object_${prev_epoch}
...
### output
output_dir: saves/ikea_action_verb_${epoch}
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
#overwrite_output_dir: true 
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_object_${prev_epoch}
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/ikea_action_verb_${epoch}
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_${epoch}
export_size: 5
export_device: cpu
export_legacy_format: false
"
  ...
  Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_${epoch}
...
### output
output_dir: saves/ikea_action_verb_object_${epoch}
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
# overwrite_output_dir: true 
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_${epoch}
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/ikea_action_verb_object_${epoch}
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/ikea_action_verb_object_${epoch}
export_size: 5
export_device: cpu
export_legacy_format: false
"
  ...
  conda activate Qwen25VL
  python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_ikea.py --task ikea_action_verb_object --epoch ${epoch}
  python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_ikea.py --task ikea_action_verb --epoch ${epoch}
  conda deactivate
