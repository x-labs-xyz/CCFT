...
Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/best_model/independent/action_verb/rh_v2/action_verb_rh_v2_32 
...
### output
output_dir: saves/objects_rh_v2_1
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/best_model/independent/action_verb/rh_v2/action_verb_rh_v2_32 
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/objects_rh_v2_1
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v2_1
export_size: 5
export_device: cpu
...
python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_single_rh_v2.py --task objects_rh_v2 --epoch "1"
conda deactivate
...
for epoch in $(seq 2 40); do
  ...
  Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v2_${prev_epoch}
...
### output
output_dir: saves/objects_rh_v2_${epoch}
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
# overwrite_output_dir: true 
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v2_${prev_epoch}
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/objects_rh_v2_${epoch}
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/objects_rh_v2_${epoch}
export_size: 5
export_device: cpu
export_legacy_format: false
"
  ...
  conda activate Qwen25VL
  python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_single_rh_v2.py --task objects_rh_v2 --epoch ${epoch}
  conda deactivate
