...
Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/best_model/independent/action_verb/rh_v1/action_verb_rh_v1_9 
...
### output
output_dir: saves/objects_rh_v1_${epoch}
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
# overwrite_output_dir: true 
