...
Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/best_model/independent/action_verb/lh_v0/action_verb_lh_v0_31
...
### output
output_dir: saves/objects_lh_v0_1
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/best_model/independent/action_verb/lh_v0/action_verb_lh_v0_31 
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/objects_lh_v0_1
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/objects_lh_v0_1
export_size: 5
export_device: cpu
...
python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_single_lh_v0.py --task objects_lh_v0 --epoch "1"
conda deactivate
...
for epoch in $(seq 2 40); do
  ...
  Objects_CONTENT="
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/objects_lh_v0_${prev_epoch}
...
### output
output_dir: saves/objects_lh_v0_${epoch}
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
# overwrite_output_dir: true 
...
### model
model_name_or_path: /home/hao/CCFT/LLaMA-Factory/models/objects_lh_v0_${prev_epoch}
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/objects_lh_v0_${epoch}
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/objects_lh_v0_${epoch}
export_size: 5
export_device: cpu
export_legacy_format: false
"
  ...
  conda activate Qwen25VL
  python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_single_lh_v0.py --task objects_lh_v0 --epoch ${epoch}
  conda deactivate
