...
### dataset
dataset: CCFT_havid_sub_videos_crop_balanced_rh_v2_multi_QA 
template: qwen2_vl 
cutoff_len: 10240 
max_samples: 100000 
...
### output
output_dir: saves/joint_rh_v2_${epoch}
logging_steps: 1 
# save_steps: 50 
plot_loss: true 
...
### model
model_name_or_path: /home/hao/CCFT/Qwen2.5-VL/Qwen2.5-VL-7B-Instruct
adapter_name_or_path: /home/hao/CCFT/LLaMA-Factory/saves/joint_rh_v2_${epoch}
template: qwen2_vl
finetuning_type: lora

### export
export_dir: /home/hao/CCFT/LLaMA-Factory/models/joint_rh_v2_${epoch}
export_size: 5
export_device: cpu
...
"
  ...
  python /home/hao/CCFT/Qwen2.5-VL/eval_alternate_single_rh_v2.py --task joint_rh_v2 --epoch ${epoch}
  conda deactivate
